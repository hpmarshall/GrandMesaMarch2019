function [ Rad, TWT ] = processCommonOffset( Rad, f0, dt, TWT, offset )
...
isSVDfilt = 1;       % Control Flag for SVD Component Subtraction Filter
...
%         fMax = f0Hz; % [Hz]
        ...
        % Function
        Rad = filter_dylan( Rad, dtSec, fMin, fMax, 8 );
    ...
    if isTimeZero
        ...
        % Function
        [Rad, TWT, ~] = timeZero( Rad, TWT, dt, merR, powMER, offset );        
    ...
    if isExpGain
        ...
        % Function
        Rad = gain_bradford(Rad, tpow, rollOff );
